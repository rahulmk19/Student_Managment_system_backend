...
public class GlobalException {
	...
	public ResponseEntity<ErrorDetails> StudentExceptionHandler(StudentException stu, WebRequest req) {

		ErrorDetails err = new ErrorDetails(stu.getMessage(), req.getDescription(false), LocalDateTime.now());
